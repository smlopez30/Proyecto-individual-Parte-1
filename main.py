...
def peliculas_idioma(idioma: str):
    '''Ingresas el idioma en formato ISO 639-1, ej: "es", retornando la cantidad de peliculas producidas en el mismo'''
...
def peliculas_duracion(pelicula: str):
    '''Ingresas la pelicula (como están escritos en el dataset, no hay que traducirlos!), ej:"Toy Story", retornando la duracion y el año de todas las películas que coinciden con el nombre'''
...
def franquicia(franquicia: str):
    '''Se ingresa el nombre de la coleccion (no hace falta que sea el nombre completo), ej:"Avatar" retornando la cantidad de peliculas, ganancia total y promedio'''
...
def peliculas_pais(pais: str):
    '''Se ingresa un país (como están escritos en el dataset, no hay que traducirlos!), ej:"Argentina" retornando la cantidad de peliculas producidas en el mismo.'''
...
def productoras_exitosas(productora: str):
    '''Se ingresa la productora (como están escritos en el dataset, no hay que traducirlos!), ej:"Twentieth Century Fox Film Corporation" entregandote el revenue total y la cantidad de peliculas que realizo.'''
...
def get_director(nombre_director: str):
    '''Se ingresa el nombre del director (como están escritos en el dataset), ej:"James Cameron" entregandote el retorno individual y las peliculas que realizo con su retorno, el budget y el renue.'''
    try:
...
def recomendacion(titulo: str):
    '''Se ingresa el titulo de la una pelicula (como están escritos en el dataset, no hay que traducirlos!), ej:"Toy Story" entregandote 5 titulos recomendados.'''
    try:
